defmodule RachelWeb.GameLiveAdvancedTest do
  ...
  describe "auto-draw system" do
    ...
    test "handles auto_draw_pending_cards message with black jack pickup", %{view: view, game_id: game_id} do
      if game_id do
    ...
    test "handles auto_draw_pending_cards when no pickups pending", %{view: view, game_id: game_id} do
      if game_id do
    ...
    test "auto draw triggers when pending pickups exist for current player", %{view: view, game_id: game_id} do
      if game_id do
    ...
    test "handles auto-play for single card of rank", %{conn: conn} do
      ...
      if game && game.players do
        ...
        if human_player do
          ...
          updated_players = Enum.map(game.players, fn p ->
